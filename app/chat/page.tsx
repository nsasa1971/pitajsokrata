...
export default function ChatPage() {
  ...
  const handleSend = useCallback(async () => {
    ...
    try {
      ...
      if (data.is_final && data.insights && data.insights.length > 0) {
  ...
  }, [input, loading, messages, user, currentSessionId, dailyTurnsUsed, supabase]);
          ...
          {messages.length === 0 && (
            <div className="flex items-center justify-center h-full text-gray-600 px-4">
              <div className="text-center space-y-3 sm:space-y-4 -mt-16">
                <div className="w-14 h-14 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-amber-500/20 to-orange-600/20 flex items-center justify-center mx-auto">
