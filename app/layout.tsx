...
export const metadata: Metadata = {
  ...
  keywords: [
    "AI savetnik", "pomoć pri odluci", "savetovanje", "Sokrat",
    "AI chat", "donošenje odluka", "besplatan savet", "veštačka inteligencija",
    "online savetnik", "pitanja i odgovori", "life coach", "savetodavni chat",
  ],
